...
running command...
$ gc2 (--version|-v)
@mapcentia/gc2-cli/2025.8.0 linux-x64 node-v24.13.1
$ gc2 --help [COMMAND]
USAGE
  $ gc2 COMMAND
...
...
_See code: [src/commands/table/event.ts](https://github.com/mapcentia/gc2-cli/blob/v2025.8.0/src/commands/table/event.ts)_

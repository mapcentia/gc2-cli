...
gc2/2022.10.0 linux-x64 node-v14.15.5
$ gc2 --help [COMMAND]
USAGE
  $ gc2 COMMAND
...
...
_See code: [src/commands/admin.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/admin.ts)_
...
_See code: [src/commands/connect.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/connect.ts)_
...
_See code: [src/commands/grid.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/grid.ts)_
...
_See code: [src/commands/login.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/login.ts)_
...
_See code: [src/commands/scheduler/start.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/scheduler/start.ts)_
...
_See code: [src/commands/seed/list.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/seed/list.ts)_
...
_See code: [src/commands/seed/log.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/seed/log.ts)_
...
_See code: [src/commands/seed/start.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/seed/start.ts)_
...
_See code: [src/commands/seed/stop.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/seed/stop.ts)_
...
_See code: [src/commands/sql.ts](https://github.com/mapcentia/gc2-cli/blob/v2022.10.0/src/commands/sql.ts)_
